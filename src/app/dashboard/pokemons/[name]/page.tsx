...
//PAGINA SIMILAR A LA DE pokemon/id HEMOS USTITUIDO LA PETICION DEL POKEMON INDIVIDUAL
//EN LUGAR DEL ID LO HAREMOS POR EL NAME QUE ES MEJOR PARA LOS BOTS DE GOOGLE MAS SIGNIFICATIVO
...
//en las Props vienen los params, en este caso el name,todos los params viene como String
interface Props {
  params: { name: string };
}
...
export async function generateStaticParams(){
    ...
    //hacemos de inicio la peticion de los 151 primeros pokemons, esta peticion se hara solo la primera vez en el build para generar
    //de forma estatica las 151 paginas de los pokemons
    const data:PokemonsReponse = await fetch(`https://pokeapi.co/api/v2/pokemon?limit=151`)
    .then( res => res.json() );

   //de la data obtenida queremos obtener el name que es lo que usaremos para generar
...
//ESTABLECEMOS LA METADARA DE FORMA DINAMICA ver video 58
...
//funcion para hacer la peticiom http, recibe el name y regresa una Promesa de tipo Pokemon
